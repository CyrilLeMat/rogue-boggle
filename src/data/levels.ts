...
export const LEVELS: Level[] = [
  ...
  { id: 'douze', label: 'J’ai plutôt genre 12 ans', hint: 'Un peu plus de temps, note à atteindre allégée', seconds: 1.25, threshold: 0.75 },
...
export const DEFAULT_LEVEL = 'adulte';
