...
export const MONOLOGUE = [
  ...
  'Un jour je serai {metier}. Ce jour-là, personne ne me parlera de {cour}.',
...
export const EV = {
  ...
  recitation: {
    ...
    wonSub: '{Maitresse} note quelque chose. Cette fois, c\'est bon signe. Ce soir, tu as droit à {plat}.',
