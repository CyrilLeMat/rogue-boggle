...
export const L = {
  ...
  sageAsk: (n: number) => `— Un mot de ${n} lettres dort dans cette feuille, petit. Les lettres sont là, en clair. Retrouve le chemin.`,
  sageHint: 'Le sage soupire et pointe la case de départ.',
  sageWrong: (n: number) => (n === 1 ? 'Le sage fronce les sourcils.' : `Le sage fronce les sourcils. (${n} essais)`),
