...
export const PROFILE_IDEAS: Record<keyof Profile, string[]> = {
  ...
  action: ['sauter partout en criant', 'courir dans les couloirs', 'faire du vélo de vitesse', 'crier très fort pour appeler maman', 'grimper aux arbres', 'manifester contre le capitalisme'],
...
export const APPRECIATIONS: Record<string, string[]> = {
  ...
  prodige: [
    ...
    'Tu ne chercherais pas une nouvelle maman, par hasard ? Mon appartement est très bien. J\'ai même une PlayStation.',
  ...
  bien: [
    ...
    'Voilà du travail sérieux. Continue et je t\'invite à manger {plat} à la maison. J\'habite à {distance} de l\'école.',
  ...
  justesse: [
    ...
    'De justesse. J\'ai hésité longtemps, un stylo rouge dans chaque main, et j\'hésite encore.',
...
export const DUEL = {
  ...
  intro: [
    ...
    'Une seconde, tu penses que tu vas devoir écrire contre quelqu\'un qui porte le prénom de ton père. Une seconde. Puis tu arrêtes de penser.',
  ],
